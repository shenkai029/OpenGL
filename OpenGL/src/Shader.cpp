...
void Shader::SetUniform1iv2(const std::string& name, const int vec[2])
{
    GLCall(glUniform1iv(GetUniformLocation(name), 2, vec));
}

int Shader::GetUniformLocation(const std::string& name) const
{
    if (m_UniformLocationCache.count(name) == 1)
